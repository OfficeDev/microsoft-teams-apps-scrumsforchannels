...
namespace Microsoft.Teams.Apps.ScrumStatus.Helpers
{
    ...
    public class TokenHelper : ITokenHelper
    {
            ...
            IOptionsMonitor<TokenOptions> tokenOptions)
        {
            ...
            scrumStatusActivityHandlerOptions = scrumStatusActivityHandlerOptions ?? throw new ArgumentNullException(nameof(scrumStatusActivityHandlerOptions));
            this.securityKey = tokenOptions.CurrentValue.SecurityKey;
            this.appBaseUri = scrumStatusActivityHandlerOptions.CurrentValue.AppBaseUri;
        }
